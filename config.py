class TrainingFeature:
    def __init__(self, add_stop_words: bool, drop_frequent_words: bool, increase_precision: bool, moderate_laplace: bool, vocab_size: int, use_existence: bool, categorize_words: bool, train_proportion: float, test_proportion: float ):
        ...
        self.INCREASE_PRECISION = increase_precision
        self.MODERATE_LAPLACE = moderate_laplace
